    ...
    <div className="space-y-6">
      <div className="flex justify-between">
        ...
        <div className="flex gap-2">
          <Link href={`/wpdata/${id}/edit`} className="rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white transition-all duration-300 hover:scale-[1.02] hover:-translate-y-0.5 hover:bg-blue-700">Edit</Link>
